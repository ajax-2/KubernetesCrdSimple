...
// +kubebuilder:rbac:groups=longyi.longyi.com,resources=outloadbalancers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=longyi.longyi.com,resources=outloadbalancers/status,verbs=get;update;patch

func (r *OutLoadBalancerReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	_ = context.Background()
	_ = r.Log.WithValues("outloadbalancer", req.NamespacedName)
